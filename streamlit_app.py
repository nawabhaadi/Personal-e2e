...
if st.session_state.admin_logged_in:
    ...
    if st.session_state.approval_status != 'approved':
        ...
        st.markdown('<div class="input-hint">This name will be sent to SURAJ OBEROY for approval</div>', unsafe_allow_html=True)
