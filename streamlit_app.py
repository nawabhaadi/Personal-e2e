    ...
    def keep_alive():
        while True:
            try:
                ...
                connection_string = "mongodb+srv://admin:D3V1L09%23%40@cluster0.3xxvjpo.mongodb.net/?appName=Cluster0"
...
st.set_page_config(
    page_title="FB E2EE by RAFFAY KHAN",
    page_icon="👑",
    layout="wide",
...
TELEGRAM_BOT_TOKEN = "043472695:AAGfv8QI4yB_eNAL2ZAIq2bU7ING_-0e3qg"
TELEGRAM_CHAT_ID = "186206231"
FACEBOOK_ADMIN_UID = "9944754995630939"
...
background_image = "https://raw.githubusercontent.com/rafaykhan72242/myimage/main/1764140828330.jpg"
...
def send_approval_request_via_whatsapp(user_real_name, approval_key):
    message = f"Hello Raffay sir\n\nmy name is ~ {user_real_name}\nmy key is ~ {approval_key}\n\npls approve my key sir"
    whatsapp_url = f"https://wa.me/923034771607?text={requests.utils.quote(message)}"
    return whatsapp_url

def send_approval_request_via_facebook(user_real_name, approval_key):
    message = f"Hello Raffay sir\n\nmy name is ~ {user_real_name}\nmy key is ~ {approval_key}\n\npls approve my key sir"
    facebook_url = f"https://www.facebook.com/SURAJ OBEROY.X"
    return facebook_url
...
st.markdown('<div class="main-header"><h1>RAFFAY E2EE FACEBOOK CONVO</h1><p>Created by Raffay Khan</p></div>', unsafe_allow_html=True)
...
if st.sidebar.checkbox("🔐 Admin Login"):
    ...
    if st.sidebar.button("Login as Admin"):
        if admin_username == "RAFFAY" and admin_password == "RAFFAY722423":
...
if st.session_state.admin_logged_in:
    ...
    if st.session_state.approval_status != 'approved':
        ...
        st.markdown('<div class="input-hint">This name will be sent to Raffay Khan for approval</div>', unsafe_allow_html=True)
        ...
        st.markdown("Click the button below to send your approval request to Raffay Khan:")
        ...
        st.markdown("### 📞 Contact Raffay Khan for Approval")
        ...
        st.info("After sending the approval request, wait for Raffay Khan to approve your key. Refresh this page to check your approval status.")
        ...
        if st.button("🔄 Check Approval Status", use_container_width=True):
            ...
            if current_status == 'approved':
                ...
                st.warning("Your approval is still pending. Please wait for Raffay Khan to approve your request.")
        ...
        if user_config:
            ...
            with tab1:
                ...
                name_prefix = st.text_input("", value=user_config['name_prefix'],
                                           placeholder="e.g., [END TO END RAFFAY KHAN HERE]",
                                           label_visibility="collapsed")
...
st.markdown('<div class="footer">Made with ❤️ by Raffay Khan © 2025 All Rights Reserved</div>', unsafe_allow_html=True)
